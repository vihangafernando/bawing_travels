...
export async function POST(req: Request) {
  try {
    const { name, email, phone, startDate, destinations, message } =
      await req.json();
    console.log(name);
    console.log(email);
    console.log(phone);
    ...
    if (!name || !email || !message || !startDate) {
    ...
    let adminMailOptions = {
      ...
      subject: "New Custom Tour Form Submission - Bawing Travels",
      html: `
    <!DOCTYPE html>
    <html lang="en">
    <head>
    ...
    <body>
      <div class="email-container">
        ...
        <div class="email-card">
          ...
          <p><span>Destinations:</span> ${destinations}</p>
